-- ============================================================
-- Rebuild Units on Offer import functions
--
-- Consolidates the working Master Unit resolution function and the
-- Units on Offer transaction with explicit enum casts and valid
-- spreadsheet-import classification.
-- ============================================================
-- ============================================================
-- Correct classification of imported Units on Offer
--
-- Imported rows are not automatic curriculum recommendations.
-- They retain origin = import and include an audit reason.
-- ============================================================
-- ============================================================
-- Fix Units on Offer import origin
-- Imported curriculum units should use origin = curriculum.
-- The source column still records semester_offering_import.
-- ============================================================
-- ============================================================
...
begin
  ...
  set
    status = 'importing'::public.import_batch_status,
  ...
  loop
    ...
    if selected_existing.id is null then
      ...
      values (
        ...
        'Imported from an approved Units on Offer workbook.',
        false,
        auth.uid(),
        auth.uid()
      )

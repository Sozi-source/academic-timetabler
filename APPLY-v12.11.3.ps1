...
$file = "src\features\student-unit-registration\programme-stage-management.tsx"
...
Write-Host ""
Write-Host "Programme stages UI redesigned successfully." -ForegroundColor Green
Write-Host "Theme: app primary teal + white + neutral surfaces." -ForegroundColor Cyan
Write-Host "Programme and stage sections are now collapsible and compact." -ForegroundColor Cyan

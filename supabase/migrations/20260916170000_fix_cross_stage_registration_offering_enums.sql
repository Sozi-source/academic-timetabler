-- The initial cross-stage registration function uses INSERT ... SELECT. Explicit
-- enum casts are required there because PostgreSQL otherwise treats literals as text.
...
begin
  ...
  select distinct
    ...
    'active'::public.unit_offering_status,
    'classroom'::public.unit_offering_type,
  ...
  do update set
    ...
    registration_status = 'registered'::public.student_unit_registration_status,

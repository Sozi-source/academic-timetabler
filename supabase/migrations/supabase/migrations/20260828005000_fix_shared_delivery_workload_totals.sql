-- Count teaching contact time per unique delivery. A confirmed shared class
-- has one allocation row per participant cohort but represents one trainer
-- delivery and must contribute to workload only once.

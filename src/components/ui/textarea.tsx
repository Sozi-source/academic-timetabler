...
>(function Textarea(
  ...
  return (
    <textarea
      ...
      className={cn(
        'w-full resize-y rounded-xl border border-border-strong bg-surface px-3 py-2.5 text-[12px] leading-5 xl:px-3.5 xl:py-3 xl:text-[13px] text-text-primary shadow-sm outline-none transition',
